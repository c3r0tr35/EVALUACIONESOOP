#Este tiene sobrecarga de constructores simulada.
MAX_ESTUDIANTES = 30
NUM_NOTAS = 3
...
class Estudiante:
    ...
    # Método alternativo de construcción (simula sobrecarga)
    @classmethod
    def con_datos(cls, codigo, nombre, edad):
        return cls(codigo, nombre, edad, activo=True)
...
class GestorCurso:
    ...
    def registrar_estudiante(self):
        ...
        # Usar método alternativo de construcción (simula constructor con parámetros)
        self.__estudiantes[slot] = Estudiante.con_datos(cod, nom, eda)
